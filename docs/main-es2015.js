...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _custom_date_time_picker_custom_date_time_picker_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./custom-date-time-picker/custom-date-time-picker.component */ "./src/app/custom-date-time-picker/custom-date-time-picker.component.ts");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 3, vars: 0, consts: [[1, "display-6", "text-center"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_custom_date_time_picker_custom_date_time_picker_component__WEBPACK_IMPORTED_MODULE_1__["CustomDateTimePickerComponent"]], encapsulation: 2 });
...
/* harmony import */ var _custom_date_time_picker_custom_date_time_picker_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./custom-date-time-picker/custom-date-time-picker.module */ "./src/app/custom-date-time-picker/custom-date-time-picker.module.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomDateTimePickerDialogComponent", function() { return CustomDateTimePickerDialogComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
function CustomDateTimePickerDialogComponent_ng_template_15_Template(rf, ctx) { if (rf & 1) {
...
function CustomDateTimePickerDialogComponent_option_23_Template(rf, ctx) { if (rf & 1) {
...
class CustomDateTimePickerDialogComponent {
    constructor(_modal, _calendar, i18n) {
        this._modal = _modal;
...
CustomDateTimePickerDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CustomDateTimePickerDialogComponent, selectors: [["ng-component"]], decls: 36, vars: 8, consts: [[1, "modal-body"], [1, "d-flex", "justify-content-center", "border", "bg-light", "rounded", "small", "text-center", "mb-1", "p-1"], [1, "mx-1", "w-50"], [1, "d-flex", "flex-column", "justify-content-center", "custom-date-time-picker"], ["outsideDays", "hidden", 3, "dayTemplate", "dateSelect"], ["datepicker", ""], ["dayTemplate", ""], [1, "d-flex", "mt-1"], [1, "input-group"], [1, "input-group-prepend"], ["for", "fromTime", 1, "input-group-text"], [1, "fa-solid", "fa-clock"], ["id", "fromTime", 1, "form-control", "form-control-sm", "rounded-0", 3, "formControl"], [3, "value", 4, "ngFor", "ngForOf"], ["id", "toTime", 1, "form-control", "form-control-sm", "rounded-0", 3, "formControl"], [1, "input-group-append"], ["for", "toTime", 1, "input-group-text"], ["class", "alert alert-danger m-0 mt-1 small", 4, "ngIf"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-outline-secondary", 3, "click"], ["type", "button", "ngbAutofocus", "", 1, "btn", "btn-primary", 3, "click"], [1, "day-template"], [3, "value"], [1, "alert", "alert-danger", "m-0", "mt-1", "small"]], template: function CustomDateTimePickerDialogComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CustomDateTimePickerDialogComponent_Template_button_click_32_listener() { return ctx.dismiss(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CustomDateTimePickerDialogComponent_Template_button_click_34_listener() { return ctx.confirm(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CustomDateTimePickerDialogComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
                templateUrl: './custom-date-time-picker-dialog.component.html'
            }]
    }], function () { return [{ type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] }, { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbCalendar"] }, { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbDatepickerI18n"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomDateTimePickerComponent", function() { return CustomDateTimePickerComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _custom_date_time_picker_dialog_custom_date_time_picker_dialog_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./custom-date-time-picker-dialog/custom-date-time-picker-dialog.component */ "./src/app/custom-date-time-picker/custom-date-time-picker-dialog/custom-date-time-picker-dialog.component.ts");
...
class CustomDateTimePickerComponent {
    constructor(_modalService) {
        this._modalService = _modalService;
        this.dateTimeRangeControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]();
    }
    select() {
        const options = { centered: true, scrollable: true, size: 'sm' };
        const modal = this._modalService.open(_custom_date_time_picker_dialog_custom_date_time_picker_dialog_component__WEBPACK_IMPORTED_MODULE_2__["CustomDateTimePickerDialogComponent"], options);
...
CustomDateTimePickerComponent.ɵfac = function CustomDateTimePickerComponent_Factory(t) { return new (t || CustomDateTimePickerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"])); };
CustomDateTimePickerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CustomDateTimePickerComponent, selectors: [["app-custom-date-time-picker"]], decls: 8, vars: 1, consts: [[1, "container", "my-5"], [1, "row"], [1, "col", "col-md-8", "offset-md-2", "col-lg-6", "offset-lg-3"], [1, "input-group"], ["type", "text", "placeholder", "Select dates and times...", "readonly", "", 1, "form-control", 3, "formControl"], [1, "input-group-append"], ["type", "button", 1, "btn", "btn-outline-secondary", 3, "click"], [1, "fa-solid", "fa-calendar-days"]], template: function CustomDateTimePickerComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CustomDateTimePickerComponent_Template_button_click_6_listener() { return ctx.select(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CustomDateTimePickerComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomDateTimePickerModule", function() { return CustomDateTimePickerModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/__ivy_ngcc__/fesm2015/ng-bootstrap.js");
/* harmony import */ var _custom_date_time_picker_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./custom-date-time-picker.component */ "./src/app/custom-date-time-picker/custom-date-time-picker.component.ts");
/* harmony import */ var _custom_date_time_picker_dialog_custom_date_time_picker_dialog_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./custom-date-time-picker-dialog/custom-date-time-picker-dialog.component */ "./src/app/custom-date-time-picker/custom-date-time-picker-dialog/custom-date-time-picker-dialog.component.ts");
...
class CustomDateTimePickerModule {
}
CustomDateTimePickerModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: CustomDateTimePickerModule });
CustomDateTimePickerModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function CustomDateTimePickerModule_Factory(t) { return new (t || CustomDateTimePickerModule)(); }, imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ReactiveFormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbDatepickerModule"]]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](CustomDateTimePickerModule, { declarations: [_custom_date_time_picker_component__WEBPACK_IMPORTED_MODULE_4__["CustomDateTimePickerComponent"], _custom_date_time_picker_dialog_custom_date_time_picker_dialog_component__WEBPACK_IMPORTED_MODULE_5__["CustomDateTimePickerDialogComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ReactiveFormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbDatepickerModule"]], exports: [_custom_date_time_picker_component__WEBPACK_IMPORTED_MODULE_4__["CustomDateTimePickerComponent"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CustomDateTimePickerModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
...
module.exports = __webpack_require__(/*! C:\Projects\GitHub\ng-bootstrap-date-time-picker\src\main.ts */"./src/main.ts");
